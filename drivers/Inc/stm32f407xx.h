...
/*
 * Interrupt Request(IRQ) number macros
 */
...
typedef struct
{
    ...
    __vo uint32_t PLLCFGR;     /*!< RCC system PLL configuration register,                                   Address offset: 0x04 */
    __vo uint32_t CFGR;        /*!< RCC clock configuration register,                                        Address offset: 0x08 */
	__vo uint32_t CIR;       /*!< RCC internal clock sources calibration register,                           Address offset: 0x0C */
    ...
    __vo uint32_t APB1RSTR;   /*!< RCC APB1 peripheral reset register 1,                                    Address offset: 0x20 */
    __vo uint32_t APB2RSTR;   /*!< RCC APB1 peripheral reset register 2,                                    Address offset: 0x24 */

    uint32_t RESERVED2;     /* RESERVED                                                                 Address offset: 0x28 */
    uint32_t RESERVED3;     /* RESERVED                                                                 Address offset: 0x2C */

    __vo uint32_t AHB1ENR;     /*!< RCC AHB1 peripheral clocks enable register,                              Address offset: 0x30 */
    __vo uint32_t AHB2ENR;     /*!< RCC AHB2 peripheral clocks enable register,                              Address offset: 0x34 */
    __vo uint32_t AHB3ENR;     /*!< RCC AHB3 peripheral clocks enable register,                              Address offset: 0x38 */
    uint32_t RESERVED4;     /* RESERVED                                                                  Address offset: 0x3C */
    __vo uint32_t APB1ENR;    /*!< RCC APB1 peripheral clocks enable register 1,                             Address offset: 0x40 */
    __vo uint32_t APB2ENR;    /*!< RCC APB1 peripheral clocks enable register 1,                             Address offset: 0x44 */

    uint32_t RESERVED5;     /* RESERVED                                                                  Address offset: 0x48 */
    uint32_t RESERVED6;     /* RESERVED                                                                  Address offset: 0x4C */

    __vo uint32_t AHB1LPENR;    /*!< RCC APB1 peripheral clocks enable register 1,                           Address offset: 0x50 */
    __vo uint32_t AHB2LPENR;    /*!< RCC APB1 peripheral clocks enable register 1,                           Address offset: 0x54 */
    __vo uint32_t AHB3LPENR;    /*!< RCC APB1 peripheral clocks enable register 1,                           Address offset: 0x58 */

    __vo uint32_t RESERVED7;     /* RESERVED                                                                  Address offset: 0x5C */


    __vo uint32_t APB1LPENR;    /*!< RCC APB1 peripheral clocks enable register 1,                           Address offset: 0x60 */
    __vo uint32_t APB2LPENR;      /*!< RCC APB1 peripheral clocks enable register 1,                         Address offset: 0x64 */

    uint32_t RESERVED8;     /* RESERVED                                                                  Address offset: 0x68 */
    uint32_t RESERVED9;     /* RESERVED                                                                  Address offset: 0x6C */

    __vo uint32_t BDCR;      /*!< RCC APB1 peripheral clocks enable register 1,                              Address offset: 0x70 */
    __vo uint32_t CSR;      /*!< RCC APB1 peripheral clocks enable register 1,                               Address offset: 0x74 */

    uint32_t RESERVED10;     /* RESERVED                                                                  Address offset: 0x78 */
    uint32_t RESERVED11;     /* RESERVED                                                                  Address offset: 0x7C */

    __vo uint32_t SSCGR;        /*!< RCC APB1 peripheral clocks enable register 1,                           Address offset: 0x80 */
    __vo uint32_t PLLI2SCFGR;      /*!< RCC APB1 peripheral clocks enable register 1,                        Address offset: 0x84 */
...
typedef struct {
	...
	__vo uint32_t MEMRM;      /*          Address offset 0x00 */
...
/*
 * Macro that will return a code 0 -7 for given GPIOx
 */
